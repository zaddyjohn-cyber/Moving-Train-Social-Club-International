  ...
  return (
    <div style={{ paddingTop: "72px", background: "var(--navy)", minHeight: "100vh" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
        ...
        {/* Search / filter bar */}
        <div style={{ background: "rgba(255,252,246,0.92)", border: "1px solid rgba(213,165,59,0.12)", borderRadius: "12px", padding: "1.25rem 1.5rem", display: "flex", flexWrap: "wrap", gap: "1rem", marginBottom: "2rem", alignItems: "center" }}>
        ...
        {/* Table placeholder */}
        <div style={{ background: "rgba(255,252,246,0.82)", border: "1px solid rgba(213,165,59,0.12)", borderRadius: "14px", overflow: "hidden" }}>
