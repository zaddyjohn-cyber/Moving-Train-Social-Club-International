    ...
    <div style={{ paddingTop: "72px", background: "var(--navy)", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
          ...
          {stats.map((stat) => (
            <Link key={stat.label} href={stat.href} style={{ textDecoration: "none" }}>
              ...
              >
                ...
                {stat.note && (
                  <p style={{ color: "rgba(174,184,198,0.35)", fontSize: "0.7rem", marginTop: "0.5rem", margin: "0.5rem 0 0", maxWidth: "100%" }}>{stat.note}</p>
                )}
              </div>
            </Link>
          ))}
        ...
        <div>
          ...
          <div style={{ background: "rgba(11,26,48,0.5)", border: "1px solid rgba(213,165,59,0.1)", borderRadius: "14px", padding: "3rem", textAlign: "center" }}>
            <AlertCircle size={28} style={{ color: "rgba(174,184,198,0.2)", marginBottom: "1rem" }} />
            <p style={{ color: "rgba(174,184,198,0.35)", fontSize: "0.875rem" }}>
