    ...
    <div style={{ paddingTop: "72px", background: "var(--navy)" }}>
      ...
      <section style={{ padding: "5rem 1.5rem", background: "var(--navy)" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <div style={{ textAlign: "center", padding: "4rem 2rem", background: "rgba(16,36,58,0.60)", border: "1px dashed rgba(213,165,59,0.15)", borderRadius: "16px" }}>
            ...
            <p style={{ color: "rgba(170,182,197,0.50)", fontSize: "0.875rem", maxWidth: "36ch", margin: "0 auto 2rem" }}>
