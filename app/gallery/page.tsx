    ...
    <div style={{ paddingTop: "72px", background: "var(--navy)" }}>
      ...
      <section aria-label="Gallery albums" style={{ padding: "3rem 1.5rem 6rem" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          {/* Notice */}
          <div style={{ background: "rgba(213,165,59,0.05)", border: "1px solid rgba(213,165,59,0.15)", borderRadius: "10px", padding: "1rem 1.5rem", marginBottom: "3rem" }}>
            <p style={{ color: "rgba(170,182,197,0.65)", fontSize: "0.875rem", lineHeight: 1.6, margin: 0, maxWidth: "100%" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "1.5rem" }}>
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      height: "200px",
                      background: "linear-gradient(135deg, rgba(8,20,38,0.90) 0%, rgba(3,7,17,0.95) 100%)",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    ...
                    <div style={{ color: "rgba(213,165,59,0.2)", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem" }}>
                      <ImageIcon size={32} />
                      <span style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif", fontSize: "0.75rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(170,182,197,0.40)" }}>
                  ...
                  <div style={{ padding: "1.5rem" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.5rem", marginBottom: "0.75rem" }}>
                      ...
                      <span style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif", fontSize: "0.75rem", color: "rgba(170,182,197,0.50)", flexShrink: 0 }}>
                        {album.year}
                      </span>
                    </div>
            ...
            >
              ...
              <p style={{ color: "rgba(170,182,197,0.50)", fontSize: "0.875rem", margin: 0, maxWidth: "24ch" }}>
          ...
          <div style={{ marginTop: "3rem", textAlign: "center", padding: "2rem", background: "rgba(16,36,58,0.60)", border: "1px solid rgba(213,165,59,0.1)", borderRadius: "16px" }}>
