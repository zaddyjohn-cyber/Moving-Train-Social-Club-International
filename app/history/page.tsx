        ...
        <div style={{ maxWidth: "820px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            {notableContributions.map((item, i) => (
              ...
              >
                <p style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif", fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--gold)", marginBottom: "0.5rem" }}>{item.member}</p>
